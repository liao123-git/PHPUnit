...
class EventDetailTest extends BaseTest
{
    protected $url;
    ...
    {
        $this->url .= 'organizers/demo1/events/wsc-2019';
    ...
    public function testB2aTicketValidity()
    {
        ...
        $url = $this->url . 'organizers/demo1/events/wsc-2019';
        $result = $this->get($url);
        ...
        $url = $this->url . 'organizers/demo2/events/vuejs-2019';
        $result = $this->get($url);
        $this->assertResponseItemAt('tickets.1', [
            'id' => 9,
            'name' => 'Early Bird',
        ...
        $url = $this->url . 'organizers/demo1/events/react-conf-2018';
        $result = $this->get($url);
        ...
        $url = $this->url . 'organizers/demo2/events/ng-2019';
        $result = $this->get($url);
        $this->assertResponseItemAt('tickets.1', [
            'id' => 12,
            'name' => 'Front Row Seat',
    ...
    public function testB2aGetInvalidEvent()
    {
        ...
        $url = $this->url . 'organizers/demo1/events/invalid-event-slug';
        $result = $this->get($url);
        $this->assertEquals([
        ...
        $url = $this->url . 'organizers/demo1/events/vuejs-2019';
        $result = $this->get($url);
        $this->assertEquals([
            'message' => 'Event not found',
        ], $result);
    ...
    public function testB2aGetInvalidOrganizer()
    {
        ...
        $url = $this->url . 'organizers/invalid-organizer-slug/events/wsc-2019';
        $result = $this->get($url);
        $this->assertEquals([
